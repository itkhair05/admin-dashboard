        ...
        <aside class="sidebar transition-all duration-300 ease-in-out">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="manage_reviews.php" class="flex items-center active"><i class="fas fa-star mr-2"></i> <span>Quản lý đánh giá</span></a></li>
                    ...
                    <li><a href="manage_promotions.php" class="flex items-center"><i class="fas fa-tags mr-2"></i> <span>Quản lý khuyến mãi</span></a></li>
